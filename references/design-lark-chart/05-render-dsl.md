...
|---|---|---|---|---|---|
| business-architecture | `straight` | `arrow` | `#ffffff` / `#dadde3` | `#1f2329` | `workspace/chart-pipeline/verify_business-architecture/` |
| system-architecture | `rightAngle` | `none` | `#fbfcfd` / `#dadde3` | `#1f2329` | `workspace/chart-pipeline/veai_demo/` |
| flowchart | `mermaid(flowchart)` 优先；复杂场景回 `straight` | `arrow` | `#ffffff` / `#98a2b3` | `#1f2329` | `workspace/chart-pipeline/reverify_20260428/` |
| swimlane | `straight` | `arrow` | `#f8fafc` / `#a9b0ba` | `#1f2329` | `workspace/chart-pipeline/verify_swimlane/` |
| sequence | `mermaid(sequenceDiagram)` | `n/a` | `n/a` | `#1f2329` | `workspace/chart-pipeline/reverify_20260428/` |
| org-chart | `rightAngle` | `arrow` | `#ffffff` / `#5b8ff9` | `#1f2329` | `workspace/chart-pipeline/verify_org-chart/` |
| state-machine | `mermaid(stateDiagram-v2)` | `n/a` | `n/a` | `#1f2329` | `workspace/chart-pipeline/reverify_20260428/` |
| funnel | `straight` | `arrow` | 多色渐进填充 / `#dadde3` | `#1f2329` | `workspace/chart-pipeline/reverify_20260428/` |
| gantt | `straight` | `none` | `#e9ebef` / `#d9dee8` | `#1f2329` | `workspace/chart-pipeline/verify_gantt/` |
| milestone | `straight` | `none` | `#57d7d0` / `#ffffff` | `#1f2329` | `workspace/chart-pipeline/verify_milestone/` |
| matrix-quadrant | `straight` | `none` | `#eaf7ee` / `#98a2b3` | `#1f2329` | `workspace/chart-pipeline/verify_matrix-quadrant/` |
| link-architecture | `straight` | `arrow` | `#eef3ff` / `#5b7fcb` | `#1f2329` | `workspace/chart-pipeline/verify_link-architecture/` |
| lark-style-architecture | `rightAngle` | `arrow` | 多色模块浅填充 / `#dadde3` + 模块语义描边 | `#1f2329` | `workspace/chart-pipeline/verify_lark-style-architecture/` |
| sketch-architecture | `straight` | `none` | `#fbfcfd` / `#5b7fcb` | `#1f2329` | `workspace/chart-pipeline/verify_sketch-architecture/` |
| complex-swimlane | `straight` | `arrow` | `#4b74d8` / `#5b7fcb` | `#1f2329` | `workspace/chart-pipeline/verify_complex-swimlane/` |
...
scripts/design_lark_chart_vendor/lint_premium_style.py <chart_type> <session>/diagram.svg \
...
```bash
scripts/design_lark_chart_vendor/lint_lark_style_architecture.py <session>/board.json
```
...
```bash
# 1. 几何门禁（Gate A）
scripts/design_lark_chart_vendor/check_board.sh <session>/board.json

# 2. 渲染 PNG（给 VQA Gate B 用）
scripts/design_lark_chart_vendor/render_preview.sh \
