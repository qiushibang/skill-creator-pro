#!/usr/bin/env python3
"""OpenAI YAML Generator - adapted to avoid external YAML deps."""
...
from frontmatter_utils import FrontmatterError, parse_frontmatter_file

ACRONYMS = {
    "GH", "MCP", "API", "CI", "CLI", "LLM", "PDF", "PR", "UI", "URL", "SQL",
}
BRANDS = {
    "openai": "OpenAI", "openapi": "OpenAPI", "github": "GitHub", "pagerduty": "PagerDuty",
    "datadog": "DataDog", "sqlite": "SQLite", "fastapi": "FastAPI",
}
...
def read_frontmatter_name(skill_dir):
    ...
    if not skill_md.exists():
        ...
        return None
    try:
        frontmatter = parse_frontmatter_file(skill_md)
...
def main():
    ...
    parser.add_argument("--interface", action="append", default=[], help="Interface override in key=value format (repeatable)")
